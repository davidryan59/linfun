...
test('test empty constructor', () => {
  ...
  expect(lf1.tMin).toEqual(0);
  expect(lf1.tMax).toEqual(0);
  expect(lf1.tStep).toEqual(0);
  expect(lf1.vMin).toEqual(0);
  expect(lf1.vMax).toEqual(0);
  expect(lf1.vStep).toEqual(0);
});

test('test constructor on single coord', () => {
  const lf1 = new Linfun([
    [-4.57, 30029.3043],
  ]);
  expect(lf1.length).toEqual(1);
  expect(lf1.array).toEqual([[-4.57, 30029.3043]]);
  expect(lf1.first).toEqual([-4.57, 30029.3043]);
  expect(lf1.last).toEqual([-4.57, 30029.3043]);
  expect(lf1.tMin).toEqual(-4.57);
  expect(lf1.tMax).toEqual(-4.57);
  expect(lf1.tStep).toEqual(0);
  expect(lf1.vMin).toEqual(30029.3043);
  expect(lf1.vMax).toEqual(30029.3043);
  expect(lf1.vStep).toEqual(0);
});

test('test constructor on multiple coords with increasing t', () => {
  const lf1 = new Linfun([
    [3.21, 5.69],
    [3.21001, 3.45],
    [3.22, 3.4405],
...
test('test coords with non-increasing t', () => {
  const lf1 = new Linfun([
    [3.21, 5.69],
    [3.20001, 3.45],
    [3.22, 3.4405],
...
test('test mapping function for t and v', () => {
  const lf1 = new Linfun([
    [1, 2],
    [3, 4],
  ]);
