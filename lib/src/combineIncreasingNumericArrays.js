...
// Function to take in multiple arrays of
// numeric values, each in increasing order
// and output a single array containing
// all distinct values in increasing order
const combineIncreasingNumericArrays = (...paramArray) => {
...
const privateCombine = (...theArrays) => {
  ...
  if (len === 3) {
    ...
    const idxLongest = (l0 > l1) ? ((l0 > l2) ? 0 : 2) : (l1 > l2) ? 1 : 2;
...
export default combineIncreasingNumericArrays;
